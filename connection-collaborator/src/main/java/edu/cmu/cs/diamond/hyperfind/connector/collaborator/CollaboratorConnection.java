...
public final class CollaboratorConnection implements Connection {
    ...
    public CollaboratorConnection(String host, String port, String trustStorePath) {
        this(host, Integer.parseInt(port), Optional.of(trustStorePath));
    }

    private CollaboratorConnection(String host, int port, Optional<String> trustStorePath) {
    ...
    public void updateCookies(Optional<String> proxyIp) {
        StringValue.Builder request = StringValue.newBuilder();
        proxyIp.ifPresent(request::setValue);
